...
class GifsControllerTest < ActionController::TestCase
  ...
  test "should create gif" do
    assert_difference('Gif.count') do
      post :create, gif: { description: @gif.description, title: @gif.title, url: @gif.url, user_id: @gif.user_id }
    end
  ...
  test "should update gif" do
    patch :update, id: @gif, gif: { description: @gif.description, title: @gif.title, url: @gif.url, user_id: @gif.user_id }
    assert_redirected_to gif_path(assigns(:gif))
  end
